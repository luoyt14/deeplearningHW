...
def main():
    ...
    def vae(observed, n, n_x, n_z):
        with zs.BayesianNet(observed=observed) as model:
            ...
            x_logstd = layers.fully_connected(lx_z, n_x, activation_fn=None)
    ...
    # Generate images
    n_gen = 100
    _, x_means = vae({}, n_gen, n_x, n_z)
    x_gen = tf.reshape(tf.sigmoid(x_means), [-1, 28, 28, 1])
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1, epochs + 1):
            ...
            if epoch % save_freq == 0:
                ...
                name = "../results/vae3_gaussian_epoch_{}.png".format(epoch)
